...
if __name__ == "__main__":
    ...
    df1 = pd.read_csv(r'src\roughml\scripts\output\Alpha effect\0.5\polar_fft2d_0.5.csv', header=0)
    df1 = np.array(df1)
    df2 = pd.read_csv(r'src\roughml\scripts\output\Alpha effect\0.6\polar_fft2d_0.6.csv', header=0)
    df2 = np.array(df2)
    df3 = pd.read_csv(r'src\roughml\scripts\output\Alpha effect\0.7\polar_fft2d_0.7.csv', header=0)
    df3 = np.array(df3)
    df4 = pd.read_csv(r'src\roughml\scripts\output\Alpha effect\0.8\polar_fft2d_0.8.csv', header=0)
    df4 = np.array(df4)
    df5 = pd.read_csv(r'src\roughml\scripts\output\Alpha effect\0.9\polar_fft2d_0.9.csv', header=0)
    df5 = np.array(df5)
    df6 = pd.read_csv(r'src\roughml\scripts\output\Alpha effect\1.0\polar_fft2d_1.0.csv', header=0)
    df6 = np.array(df6)
